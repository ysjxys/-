...
@property (nonatomic, strong) AMapNaviHUDViewController *naviHUDViewController;
...
- (void)viewDidLoad
{
    ...
    [self initNaviHUDViewController];
    [self configSubViews];
}

#pragma mark - Init &Constructs

- (void)initNaviHUDViewController
{
    if (_naviHUDViewController == nil)
    {
        _naviHUDViewController = [[AMapNaviHUDViewController alloc] initWithDelegate:self];
    }
}
...
- (void)naviManagerOnCalculateRouteSuccess:(AMapNaviManager *)naviManager
{
    ...
    [self.naviManager presentNaviViewController:self.naviHUDViewController animated:YES];
}
